		...
		if(FF2_HasAbility(boss, this_plugin_name, "special_cbs_multimelee"))
		{
			if(GetEntPropEnt(attacker, Prop_Send, "m_hActiveWeapon")==GetPlayerWeaponSlot(attacker, TFWeaponSlot_Melee))
			{
				...
				switch(GetRandomInt(0, 2))
				{
					case 0:
					{
						weapon=SpawnWeapon(attacker, "tf_weapon_club", 171, 101, 5, "15 ; 0 ; 68 ; 2 ; 2 ; 3.1 ; 214 ; 33 ; 275 ; 1");
					}
					case 1:
					{
						weapon=SpawnWeapon(attacker, "tf_weapon_club", 193, 101, 5, "15 ; 0 ; 68 ; 2 ; 2 ; 3.1 ; 214 ; 66 ; 275 ; 1");
					}
					case 2:
					{
						weapon=SpawnWeapon(attacker, "tf_weapon_club", 232, 101, 5, "15 ; 0 ; 68 ; 2 ; 2 ; 3.1 ; 214 ; 99 ; 275 ; 1");
					}
				}
